...
/**
 * M-Pesa Callback API.
 * Handles the callback from Safaricom after an STK Push payment.
 * Verifies payment success, creates a transaction, updates order status,
 * adjusts inventory, and sends a notification.
 */
